  ...
  return (
    ...
    >
      ...
      >
        ...
        <TextInput label="Pay" value={pay} onChangeText={setPay} style={styles.input} theme={theme} />
        <TextInput
        ...
        <Modal isVisible={isModalVisible} style={styles.modal} onBackdropPress={toggleModal}>
          <View style={styles.modalContent}>
            {timeUnits.map((unit, index) => (
              <List.Item key={index} title={unit} onPress={() => handleSelectTimeUnit(unit)} />
            ))}
        ...
        >
          <View style={styles.modalContent}>
            {categories.map((category, index) => (
              <List.Item key={index} title={category} onPress={() => handleSelectCategory(category)} />
            ))}
            <Button onPress={toggleCategoryModal}>Close</Button>
          </View>
        </Modal>

        <Button mode="contained" onPress={handlePost} style={styles.button} disabled={!isFormValid()}>
          Post Job
        </Button>
      </KeyboardAwareScrollView>
    </KeyboardAvoidingView>
